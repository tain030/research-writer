...
- MaruBuri Regular and SemiBold, downloaded from NAVER's official Hangeul
  campaign distribution.
- NanumGothicCoding Regular, downloaded from the official
  [`naver/nanumfont`](https://github.com/naver/nanumfont) release.

These fonts are redistributed under the SIL Open Font License 1.1. The font
files remain copyright their respective authors and are not covered by
